...
/**
 * La clase Controlador actúa como intermediario entre la vista (Vista) y el
 * modelo (Operaciones).
 * Se encarga de gestionar la lógica de la aplicación, solicitando datos a la
 * vista y
...
public class Controlador {
     ...
     *
     * @param vista Objeto de la clase Vista que se utilizará para la interacción
     *              con el usuario.
     */
     ...
     * Solicita dos números al usuario, realiza operaciones matemáticas y muestra
     * los resultados.
     */
